...
class LottieAlertDialog : AlertDialog
{
    ...
    private fun setView()
    {
        ...
        else if (mType == DialogTypes.TYPE_WARNING)
        {
            ...
            lAnimation.repeatCount=0
        } else if (mType == DialogTypes.TYPE_DELETE)
        {
            lAnimation.setAnimation("delete.json")
            lAnimation.repeatCount=0
        } else if (mType == DialogTypes.TYPE_LOGOUT)
        {
            lAnimation.setAnimation("logout.json")
            lAnimation.repeatCount=LottieDrawable.INFINITE
        } else if (mType == DialogTypes.TYPE_MESSAGE)
        {
            lAnimation.setAnimation("message.json")
            lAnimation.repeatCount=LottieDrawable.INFINITE
        }
